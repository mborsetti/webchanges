# ruff: noqa S101, PT014
# pragma: exclude file
"""
Vendored version of tests for packaging.version.parse() from packaging v23.2 released on 01-Oct-23
(commit https://github.com/pypa/packaging/commit/7e4f2588923e647bb7c3d5b350473e39e4b279d4).

See https://github.com/pypa/packaging and https://github.com/pypa/packaging/blob/main/tests/test_version.py.

We make the "pretend" library optional.
"""
...
from webchanges._vendored.packaging_version import InvalidVersion, Version, parse
...
class TestVersion:
    ...
    def test_version_epoch(self, version: str, epoch: str) -> None:
    ...
    def test_version_release(self, version: str, release: str) -> None:
    ...
    def test_version_local(self, version: str, local: str) -> None:
    ...
    def test_version_pre(self, version: str, pre: str) -> None:
    ...
    def test_version_is_prerelease(self, version: str, expected: str) -> None:
    ...
    def test_version_dev(self, version: str, dev: str) -> None:
    ...
    def test_version_post(self, version: str, post: str) -> None:
    ...
    def test_comparison_true(self, left: str, right: str, op: Callable[[Any, Any], bool]) -> None:
    ...
    def test_comparison_false(self, left: str, right: str, op: Callable[[Any, Any], bool]) -> None:
